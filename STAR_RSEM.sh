...
read2=$2 #gzipped fastq file for read2, use "" if single-end
STARgenomeDir=$3 
RSEMrefDir=$4
...
str_PE)
      ...
      ;;            #### for Illumina stranded/TruSeq strand specific RNA-seq/ dUTP second strand, all 							    #### reads are from the first synthesized cDNA (reverse strand of the original RNA)
unstr_SE)
